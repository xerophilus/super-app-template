...
const packageJson = {
  ...
  "scripts": {
    ...
    "bundle": "mkdir -p ../bundles/${normalizedAppName} && esbuild src/index.tsx --bundle --platform=node --format=cjs --outfile=../bundles/${normalizedAppName}/bundle.js --external:react --external:react-native --external:react-native-safe-area-context --external:@react-navigation/native --external:@react-navigation/native-stack --external:react-native-screens",
